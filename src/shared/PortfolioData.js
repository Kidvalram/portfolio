...
export const PortfolioData = {
    ...
    description: {
        fr: <>{'Ingénieur Electronique, avec une pasion sur l’Internet des objets, m’a fait pencher vers le développement d’applications et le design UX/UI, depuis sa conception, son développement et le lancement du produit dans la vie réelle. Originaire du Mexique, la terre de la Tequila et maintenant vivant dans la mer Méditerranée en France, je suis à la recherche de nouveaux défis dans la vie professionnelle.'}<br/><br/><div className='md:hidden xl:flex'>{'J’ai développé des applications et des sites Web qui peuvent vous intéresser, n’hésitez pas à jeter un oeil à mes projets que j’ai certainement essayé d’inspirer quelqu’un d’autre, contactez-moi si vous avez des questions.'}</div></>,
        ...
        projects:[
            {
                ...
                description:{
                    fr: "Un menu en ligne que les clients peuvent voir les produits offerts par le restaurant, les utilisateurs peuvent sélectionner les produits et les enregistrer dans un panier afin que les utilisateurs puissent les montrer au serveur et il peut voir leur commande.",
            ...
            },
            {
                ...
                resume:{
                    fr: "Le projet enregistre la date, l’heure et le lieu des pièces et les affiche dans une application en Android",
            ...
            },
            {
                ...
                resume:{
                    fr: "Le site Web créé avec React et MongoDB, vous invite avec la conception vouloir réserver le voyage de vos rêves",
                ...
                description:{
                    fr: "Page créée avec Javascript avec React et base de données avec MongoDB, le site a été créé dans le but d’attirer l’attention du client dans tous les détails de la page et de cette manière, le client a le désir de réserver le Van.",

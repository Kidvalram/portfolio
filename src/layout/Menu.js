  ...
  return (
    <Div100vh>
        ...
        <motion.div className='relative w-[100vw] h-full flex flex-col lg:flex-row justify-between'>
            ...
            <div className='relative flex flex-col items-center justify-evenly md:justify-between md:pt-0 lg:justify-between h-[70vh] md:h-[62vh] lg:h-full lg:w-[75vw] 2xl:w-[70vw]'>
